...
function showNextQuestion() {
    // Check if this the end of the quiz
...
function submitAnswer(event) {
    ...
    if (option2.checked) {
        // Add option2 to user answers array
...
function checkAnswers() {
    ...
    alert("Congrats! You got " + numCorrect + " out of " + questions.length);
